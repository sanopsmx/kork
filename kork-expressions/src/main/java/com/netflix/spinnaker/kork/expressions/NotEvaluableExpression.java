 ...
 *
 * <p>
 * For example, in the evaluation context is defined only {@code fileMap} object:
 *
 * <pre>
 * {
 *   &#64;code
 ...
 *
 * <p>
 * An exception will be thrown in attempt to get JSON because of {@code fileMap} contains SpEL
 * inside.
 *
 * <pre>
 * {@code
 ...
 *
 * <p>
 * In the given case {@code fileMap} contains SpEL for another tool e.g. Terraform. Use {@code
