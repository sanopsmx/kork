...
public interface SpinnakerExtensionPoint extends ExtensionPoint {
  ...
  /**
   * Return the plugin ID this extension point implementation is associated with. Returns "default" if
   * extension point is not associated with a plugin.
   */
   ...
   * instrumentation (logging, metrics, etc). To get the extension class type, use this method instead
   * of {@link #getClass()}.
   */
